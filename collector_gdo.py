...
PATH_JSON1 = "data/waze_partnerhub_gdo.json"
PATH_JSON2 = "data/waze_openwebninja_gdo.json"

# ── Credenciales (leídas desde variables de entorno / secrets) ──
PARTNER_URL = os.getenv(
    "WAZE_PARTNER_URL_GDO",
    "https://www.waze.com/row-partnerhub-api/partners/12221294397/"
    "waze-feeds/9731e099-d541-4bfd-9ac3-44d313e4e420?format=1",
)
